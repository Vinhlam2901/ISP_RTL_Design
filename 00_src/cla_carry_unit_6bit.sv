...
//============================================================================================================
module cla_carry_unit_6bit (
	input  wire [5:0] p_i,
	input  wire [5:0] g_ni,
	input  wire       cin_i,
	output reg  [5:0] cin_out,
	output reg        p_o,
	output reg        g_no
);
//==================DECLARATION=======================================================================
...
//==================CARRY=============================================================================
	...
	always_comb begin : carry_calc
		...
		cin_temp[5] = ~(g_ni[5] & ~(p_i[5]                                              & ~g_ni[4]) 
													  & ~(p_i[5] & p_i[4] 									                  & ~g_ni[3])
													  & ~(p_i[5] & p_i[4] & p_i[3] 									          & ~g_ni[2])
													  & ~(p_i[5] & p_i[4] & p_i[3] & p_i[2]                   & ~g_ni[1]) 
													  & ~(p_i[5] & p_i[4] & p_i[3] & p_i[2] & p_i[1]          & ~g_ni[0]) 
													  & ~(p_i[5] & p_i[4] & p_i[3] & p_i[2] & p_i[1] & p_i[0] & cin_i   ));										 											 
	end
