...
module cla_adder_24bit (
	...
	input  wire        cin_i,
	output reg         cout_o,
	output reg  [23:0] result_o 
);
//===============DECLARATION=====================================================================================
  wire [5:0] prog_temp, gen_ntemp;
	wire [5:0] cin_out;
	wire       p_o, g_no;
//===============RESUTL_PROCESS==========================================================================================
	...
	cla_adder_4bit cla_5 (.a_i(a_i[23:20]),.b_i(b_i[23:20]),.cin_i(cin_out[4]),.prog_o(prog_temp[5]),.gen_no(gen_ntemp[5]),.s_o(result_o[23:20]));
//===============CARRY_PROCESS==========================================================================================
	cla_carry_unit_6bit carry_process (.p_i(prog_temp),.g_ni(gen_ntemp),.cin_i(cin_i),.cin_out(cin_out),.p_o(p_o),.g_no(g_no));
